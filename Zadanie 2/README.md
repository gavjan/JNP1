...
The purpose of this task is to write a C++ module that handles Partially
Ordered Sets(poset) whose elements are strings. The module is to be used in C and is to provide the following functions:
